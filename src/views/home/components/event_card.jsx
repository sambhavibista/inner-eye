...
function EventCard() {
  return (
    <Card sx={{ maxWidth: "287px", width: "100%"  , Radius: "0px, 0px , 20px, 20px" }}>
      <Box sx={{ padding:"0", position: "relative" }}>
        <img src={satsang} alt="satsang" style={{ objectFit: "cover", width: "100%" }} />
        <CardContent sx={{ padding:"0", position: "absolute", bottom: 0, left: 0, right: 0, backgroundColor: "#00000040" , Radius: "0px, 0px , 20px, 20px" }}>
